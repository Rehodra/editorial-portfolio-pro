  ...
  return (
    <section className="relative min-h-screen bg-background overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none hidden lg:block">
        ...
        <div className="absolute top-0 bottom-0 left-[35%] w-px bg-border/30" />
      </div>
      ...
      <motion.div
        ...
        className="absolute bottom-0 left-[25%] xl:left-[30%] pointer-events-none hidden lg:flex items-end justify-center"
        style={{ height: "100%" }}
      >
        ...
        >
          <svg width="120" height="80" viewBox="0 0 100 70" fill="none" className="text-foreground/70">
            <path d="M10 35 Q25 10 40 35 Q55 60 70 35 Q85 10 95 35" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" />
            <path d="M5 40 Q20 15 35 40 Q50 65 65 40 Q80 15 90 40" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" />
            <path d="M15 30 Q30 5 45 30 Q60 55 75 30 Q90 5 100 30" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" />
          </svg>
        </motion.div>
      </motion.div>
        ...
        {stats.map((stat, index) => (
          ...
          >
            <div className="flex flex-col items-end">
              <div className="text-3xl xl:text-4xl font-bold text-foreground">{stat.value}</div>
        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="max-w-2xl">
            ...
            >
              ...
              Greeting, I'm Mounasuvra <span className="text-xl">👋</span>
            </motion.p>
            ...
            >
              <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                I work across every stage of product development, combining intuitive interface design with robust backend engineering.
              </p>
            </motion.div>
